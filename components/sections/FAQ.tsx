...
const FAQS = [
  ...
  {
    q: "Как быстро приходит покупка после оплаты и можно ли вернуть деньги?",
    a: "Привилегия или предмет выдаются автоматически на сервере в течение нескольких минут после подтверждения оплаты — заходить в игру заново не нужно. Если по техническим причинам покупка не пришла, напишите в поддержку личного кабинета — мы либо выдадим её вручную, либо вернём деньги. Возврат средств также возможен на условиях, указанных в оферте (ссылка в подвале сайта): например, если услуга не была оказана или оказана с нарушением сроков.",
  },
  {
